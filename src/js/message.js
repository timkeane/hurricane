...
const messages = {
	...
	location_no_zone: '<h2>${oem_supplied}</h2><div class="notranslate" translate="no">${name}</div>',
	location_zone_order: '<h2>${oem_supplied}<br>${order}</h2><div class="notranslate" translate="no">${name}</div>',
	location_zone_unkown: '<h2>${oem_supplied}</h2><div class="notranslate" translate="no">${name}</div>',
	location_zone_unkown_311: '<div><div>${oem_supplied}</div><div class="notranslate" translate="no">${name}</div></div>',
